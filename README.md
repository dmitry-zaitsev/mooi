...
running command...
$ mooi (--version)
mooi-cli/1.0.2 darwin-x64 node-v18.16.0
$ mooi --help [COMMAND]
USAGE
  $ mooi COMMAND
...
...
_See code: [dist/commands/translate/index.ts](https://github.com/dmitry-zaitsev/mooi/blob/v1.0.2/dist/commands/translate/index.ts)_
<!-- commandsstop -->
